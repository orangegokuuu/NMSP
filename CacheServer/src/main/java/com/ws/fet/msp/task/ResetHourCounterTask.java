...
@Log4j2
@SpringAware
public class ResetHourCounterTask implements Task<Void> {
	/**
	 * 
	 */
	...
	public Void call() throws Exception {
		log.debug("Resetting Hourly Counter...");
		quotaManager.resetQueryDrHourlyCount();
		quotaManager.resetSubmitLimit();
		return null;
	}
