...
@XmlRootElement(name = "QueryDRResp")
public class QueryDRResp {

    @XmlElement(name = "ResultCode", required = true)
    protected String resultCode;
    @XmlElement(name = "Message", required = true)
    protected List<QueryDRResp.Message> message;
     ...
     * {@link QueryDRResp.Message }
     * 
     * 
     */
    public List<QueryDRResp.Message> getMessage() {
        if (message == null) {
            message = new ArrayList<QueryDRResp.Message>();
        }
        return this.message;
    }
    ...
    public static class Message {
        ...
        protected QueryDRResp.Message.DeliveryReport deliveryReport;
        @XmlElement(name = "DRDetail")
        protected QueryDRResp.Message.DRDetail drDetail;
         ...
         * @return
         *     possible String is
         *     {@link QueryDRResp.Message.DeliveryReport }
         *     
         */
        public QueryDRResp.Message.DeliveryReport getDeliveryReport() {
         ...
         *     
         */
        public void setDeliveryReport(QueryDRResp.Message.DeliveryReport value) {
         ...
         * @return
         *     possible String is
         *     {@link QueryDRResp.Message.DRDetail }
         *     
         */
        public QueryDRResp.Message.DRDetail getDRDetail() {
            return drDetail;
        }
         ...
         *     
         */
        public void setDRDetail(QueryDRResp.Message.DRDetail value) {
            this.drDetail = value;
        }
        ...
        public static class DRDetail {
            ...
            protected List<QueryDRResp.Message.DRDetail.Detail> detail;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link QueryDRResp.Message.DRDetail.Detail }
             * 
             * 
             */
            public List<QueryDRResp.Message.DRDetail.Detail> getDetail() {
                if (detail == null) {
                    detail = new ArrayList<QueryDRResp.Message.DRDetail.Detail>();
                }
                return this.detail;
            }
