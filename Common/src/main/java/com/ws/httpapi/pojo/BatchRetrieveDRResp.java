...
// 產生時間: 2017.10.12 於 02:52:34 PM CST 
//
...
@XmlRootElement(name = "BatchRetrieveDRResp")
public class BatchRetrieveDRResp {
    ...
    protected List<BatchRetrieveDRResp.DeliveryReport> deliveryReport;
     ...
     * {@link BatchRetrieveDRResp.DeliveryReport }
     * 
     * 
     */
    public List<BatchRetrieveDRResp.DeliveryReport> getDeliveryReport() {
        if (deliveryReport == null) {
            deliveryReport = new ArrayList<BatchRetrieveDRResp.DeliveryReport>();
        }
